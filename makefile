...
clean :
	rm soutenance.aux soutenance.log soutenance.maf soutenance.mtc* soutenance.out soutenance.toc soutenance.tex.* soutenance.pyg soutenance.snm soutenance.nav; rm suivi.aux suivi.log suivi.maf suivi.mtc* suivi.out suivi.toc suivi.tex.* suivi.pyg suivi.snm suivi.nav
